...
subtitle: "Numbers Sets and Topology"
...
::: fragment
-   a set contains its **inverse** if for every element of the set there exists another element $(z)$ where $x\circ z = e$. for example with respect to addition $x, -x$ are inverses. <br>
:::
